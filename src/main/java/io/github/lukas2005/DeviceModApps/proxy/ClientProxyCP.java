...
//
//public class ClientProxyCP implements IProxy {
//
...
//            Utils.registerFontRenderer(mc, ClientProxyCP.myFontRenderer);
//            // Swap the laptop renderer to my own one
//            Utils.setFinalStatic(Laptop.class.getField("fontRenderer"), ClientProxyCP.myFontRenderer);
//        } catch (Exception e1) {
//            e1.printStackTrace();
//        }
//    }
